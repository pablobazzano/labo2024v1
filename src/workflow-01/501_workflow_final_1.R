...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 100L, 1024L,  "integer" ),
...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z571_ZZ_final_semillerio.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_f1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_f1", "DT0001_f1" )
  
  DR_drifting_guantesblancos( "DR0001_f1", "CA0001_f1" )
  FE_historia_guantesblancos( "FE0001_f1", "DR0001_f1" )
  
  TS_strategy_guantesblancos_202109( "TS0001_f1", "FE0001_f1" )
  
  HT_tuning_guantesblancos( "HT0001_f1", "TS0001_f1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_f1", c("HT0001_f1","TS0001_f1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_f1", "FE0001_f1" )
  
  HT_tuning_guantesblancos( "HT0002_f1", "TS0002_f1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_f1", c("HT0002_f1", "TS0002_f1") )
...
corrida_guantesblancos_202109( "gb01_f1" )
