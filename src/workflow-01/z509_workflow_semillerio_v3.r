...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-sem12", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-sem12", "DT0001-sem12" )
  
  DR_drifting_baseline( "DR0001-sem12", "CA0001-sem12" )
  FE_historia_baseline( "FE0001-sem12", "DR0001-sem12" )
  
  TS_strategy_baseline_202109( "TS0001-sem12", "FE0001-sem12" )
  
  HT_tuning_baseline( "HT0001-sem12", "TS0001-sem12" )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem12", c("HT0001-sem12","TS0001-sem12") )
...
corrida_baseline_semillerio_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202107( "TS0002-sem12", "FE0001-sem12" )
  
  HT_tuning_baseline( "HT0002-sem12", "TS0002-sem12" )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem12", c("HT0002-sem12","TS0002-sem12") )
...
corrida_baseline_semillerio_202109( "basem01_12" )
