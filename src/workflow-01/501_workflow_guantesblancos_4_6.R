...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_4_6", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_4_6", "DT0001_4_6" )
  
  DR_drifting_guantesblancos( "DR0001_4_6", "CA0001_4_6" )
  FE_historia_guantesblancos( "FE0001_4_6", "DR0001_4_6" )
  
  TS_strategy_guantesblancos_202109( "TS0001_4_6", "FE0001_4_6" )
  
  HT_tuning_guantesblancos( "HT0001_4_6", "TS0001_4_6" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_4_6", c("HT0001_4_6","TS0001_4_6") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_4_6", "FE0001_4_6" )
  
  HT_tuning_guantesblancos( "HT0002_4_6", "TS0002_4_6" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_4_6", c("HT0002_4_6", "TS0002_4_6") )
...
corrida_guantesblancos_202109( "gb01_4_6" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_4_6" )
